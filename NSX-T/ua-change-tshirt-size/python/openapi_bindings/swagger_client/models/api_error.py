...
import six
from swagger_client.models.related_api_error import RelatedApiError  # noqa: F401,E501

class ApiError(RelatedApiError):
    ...
    def __init__(self, related_errors=None, *args, **kwargs):  # noqa: E501
