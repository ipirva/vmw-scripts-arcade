...
class LogicalPortMacAddressListResult(ListResult):
    ...
    def __init__(self, logical_port_id=None, last_update_timestamp=None, results=None, transport_node_id=None, *args, **kwargs):  # noqa: E501
