...
class LbSourceIpPersistenceProfile(LbPersistenceProfile):
    ...
    def __init__(self, purge='FULL', ha_persistence_mirroring_enabled=False, timeout=300, *args, **kwargs):  # noqa: E501
