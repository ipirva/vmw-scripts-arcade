...
class SystemAdministrationConfigurationFabricPoolManagementVNIPoolsApi(object):
    ...
    def create_vni_pool(self, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.create_vni_pool_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_vni_pool_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_vni_pool_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a new VNI Pool.  # noqa: E501

        Creates a new VNI pool using the specified VNI pool range. The range should be non-overlapping with an existing range. If the range in payload is present or overlaps with an existing range, return code 400 with bad request and an error message is returned mentioning that the given range overlaps with an existing range.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_vni_pool_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_vni_pool`")  # noqa: E501
    ...
    def delete_vni_pool(self, pool_id, **kwargs):  # noqa: E501
        """Delete a VNI Pool  # noqa: E501

        Deletes the given VNI pool.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_vni_pool(pool_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_vni_pool_with_http_info(pool_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_vni_pool_with_http_info(pool_id, **kwargs)  # noqa: E501
            return data

    def delete_vni_pool_with_http_info(self, pool_id, **kwargs):  # noqa: E501
        """Delete a VNI Pool  # noqa: E501

        Deletes the given VNI pool.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_vni_pool_with_http_info(pool_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('pool_id' not in params or
            ...
            raise ValueError("Missing the required parameter `pool_id` when calling `delete_vni_pool`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pools/vni-pools/{pool-id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
