...
class SystemAdministrationConfigurationNSXManagersClustersClusterCertificateApi(object):
    ...
    def set_cluster_certificate_set_cluster_certificate(self, certificate_id, **kwargs):  # noqa: E501
        ...
        Sets the certificate used for the MP cluster. This affects all nodes in the cluster. If the certificate used is a CA signed certificate,the request fails if the whole chain(leaf, intermediate, root) is not imported.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
