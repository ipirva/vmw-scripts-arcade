...
class SystemAdministrationConfigurationFabricNodesServicesSNMPApi(object):
    ...
    def read_snmp_service(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param bool show_sensitive_data: Show SNMP sensitive data or not
    ...
    def read_snmp_service_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['show_sensitive_data']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
